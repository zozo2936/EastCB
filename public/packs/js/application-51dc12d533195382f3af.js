...
// Module
exports.push([module.i, "body {\n  margin: 10px;\n  padding: 10px;\n  text-align: center; }\n\n.field_with_errors input {\n  border: 1px red solid; }\n\n.nav.pagination .page {\n  background-color: #ccf;\n  padding: 10px;\n  font-size: 15px; }\n\narticle.book_descrption p {\n  margin-bottom: 1rem; }\n", "",{"version":3,"sources":["/Users/arios/projects/EastCB/app/javascript/stylesheets/application.scss"],"names":[],"mappings":"AAAA;EACI,YAAY;EACZ,aAAa;EACb,kBAAkB,EAAA;;AAItB;EACI,qBAAqB,EAAA;;AAGzB;EAEQ,sBAAsB;EACtB,aAAa;EACb,eAAe,EAAA;;AAIvB;EAEQ,mBAAmB,EAAA","file":"application.scss","sourcesContent":["body {\n    margin: 10px;\n    padding: 10px;\n    text-align: center;\n}\n\n\n.field_with_errors input {\n    border: 1px red solid;\n}\n\n.nav.pagination {\n    .page {\n        background-color: #ccf;\n        padding: 10px;\n        font-size: 15px;\n\n    }\n}\narticle.book_descrption{\n    p{\n        margin-bottom: 1rem;\n    }\n}"]}]);
...
/******/ });
//# sourceMappingURL=application-51dc12d533195382f3af.js.map