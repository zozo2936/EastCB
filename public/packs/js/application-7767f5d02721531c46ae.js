...
var map = {
	"./book_controller.js": "./app/javascript/controllers/book_controller.js",
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "add_to_cart",
    value: function add_to_cart(evt) {
      evt.products;
    }
  }]);
  ...
  _createClass(_default, [{
    ...
    value: function toggle(evt) {
      ...
      helpers_ax__WEBPACK_IMPORTED_MODULE_1__["default"].post("/api/books/".concat(id, "/favorite")).then(function (response) {
        var favorited = response.data.favorited;
...
/******/ });
//# sourceMappingURL=application-7767f5d02721531c46ae.js.map